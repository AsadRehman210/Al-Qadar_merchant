      ...
      <div className="relative z-[1]">
        ...
        >
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <FormInput label={t("finance:category")} name="category" pattern={/[a-zA-Z0-9\s.'-]/} minLength={2} maxLength={200} register={register} required />
            ...
            <SelectDropdown label={t("finance:category")} data={expenseOpts} selected={selExpense} setSelected={setSelExpense} hideClear classes="!h-[46px] !rounded-lg" />
          </div>
